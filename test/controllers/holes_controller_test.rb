...
class HolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hole" do
    assert_difference('Hole.count') do
      post holes_url, params: { hole: { holenumber: @hole.holenumber, par: @hole.par, score: @hole.score } }, as: :json
    end
  ...
  test "should update hole" do
    patch hole_url(@hole), params: { hole: { holenumber: @hole.holenumber, par: @hole.par, score: @hole.score } }, as: :json
    assert_response 200
  end
